/*
  ...
  Version #2 programmed by JDMozo - July, 2020
...
/* USB command set
fn      == Freq (n = millisec 0 to 1024)     replace manual panel control 
...
vn      == Valve                             toggle valve n state (n = 1 to 5)
...
//        Serial.println(volt,DEC);
        break;
//      case 'v':                                      // toggle valve
//        int valveNum = Serial.parseInt();            // read number of valve
//        valveNum = constrain(valveNum, 1, 5);        // avoid out-of-range values
//        int prevState;
//        if (valveNum == 1) {
//            prevState = digitalRead (V1);            // read previous setting
//            digitalWrite(V1, !prevState); }          // toggle setting
//        else if (valveNum == 2) {
//            prevState = digitalRead (V2);            // read previous setting
//            digitalWrite(V2, !prevState); }          // toggle setting
//        else if (valveNum == 3) {
//            prevState = digitalRead (V3);            // read previous setting
//            digitalWrite(V3, !prevState); }          // toggle setting
//        else if (valveNum == 4) {
//            prevState = digitalRead (V4);            // read previous setting
//            digitalWrite(V4, !prevState); }          // toggle setting
//        else if (valveNum == 5) {
//            prevState = digitalRead (V5);            // read previous setting
//            digitalWrite(V5, !prevState);            // toggle setting
//        }
//        Serial.print("Ok, ");                        // Handshaking Ok
//        Serial.print(serialData);
...
//        break;
  ...
  if (buttonState == HIGH && runMotor == HIGH && runLOAD == HIGH) {      
    ...
    runMotor = LOW; 
    Serial.print("tl");                             // to sinc with computer app
    Serial.println(millis(),DEC);}                  // to sinc with computer app
  ...
  if (remote == LOW) {                              // manual mode
    ...
    if (currentTime - previousTimeVolt >= 500000L) {
      ...
      Serial.print('v');                            // write in serial USB to PC sinchronization
      Serial.println(volt, DEC);}}    
